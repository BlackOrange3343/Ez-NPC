...
local Properties = {
	...
	NPC_SPAWNER_DIRECTORY = Workspace.Spawners,  -- Where spawners are at
	...
	CREATE_MISC_DATA = false, -- This is preferred on false bubt can be set to true for thos who wish to have it on true
